function Diatomic_Coulomb(atom1, atom1_x, atom1_y, atom1_charge, atom2, atom2_x, atom2_y, atom2_charge, total_steps)
...
for i = 1:total_steps
   ...
   %Pythagoras
   r_1_2 = sqrt((r_1_x_curr - r_2_x_curr)^2 + (r_1_y_curr - r_2_y_curr)^2);
   r_2_1 = r_1_2;
   ...
   v_1_curr = sqrt(v_1_x_curr^2 + v_1_y_curr^2);
   v_2_curr = sqrt(v_2_x_curr^2 + v_2_y_curr^2);
   %Positions
   %New Positions
